...
$portletclass = ($portlet->preset) ? 'courseshop-visible' : 'courseshop-hidden' ;
?>
<tr id="producttotalcaption_<?php echo $portlet->shortname ?>" class="<?php echo $portletclass ?>">
  <td class="courseshop-ordercaptioncell" colspan="3">
     <?php echo $portlet->name ?>
  </td>
</tr>
<tr id="producttotal_<?php echo $portlet->shortname ?>" class="<?php echo $portletclass ?>">
  <td class="courseshop-ordercell">
