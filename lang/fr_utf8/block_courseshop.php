...
//capabilities
$string['courseshop:beassigned'] = "Peut être assigné à une opération";
$string['courseshop:salesadmin'] = "Est administrateur des ventes";
...
$string['configsellerID'] = 'Numéro d\'identité administrative de commerçant ou société';
...
$string['configuseshipping'] = 'Si activé, le calcul des frais de port pour les produits matériels est effectué';
$string['configtestmode'] = 'Permet d\'effectuer des opérations en mode test (Paypal, Systempay, etc.)';
...
$string['countrycodelist'] = 'Liste restrictive des codes pays';
...
$string['configdefaultcountry'] = 'Pays par défaut du client (défaut pour toutes les boutiques)';
$string['defaultcountry'] = 'Pays par défaut du client';
$string['customerdefaultcountry'] = 'Pays par défaut du client';
$string['customerorganisationrequired'] = 'Organisation requise dans les données clientes';
...
$string['eulaurl'] = 'URL de licence';
$string['eulaheading'] = 'Conditions de vente';
$string['eulaagree'] = 'J\'accepte les conditions de vente';
$string['eula_help'] = 'Certains des produits qui figurent dans votre commande nécessitent l\'approbation de certaines conditions de vente particulièress, concernant notamment des limites de service,  des services complémentaires rattachés à vos produits ou des clauses relatives aux données personnelles. Nous vous demandons de lire attentivement les notices suivantes et de valider votre approbation avent de pouvoir terminer votre commande. Merci de votre compréhension.';
...
$string['printtabbedcategories'] = 'Activer les onglets de catégories';
$string['quant'] = 'Quant';
...
$string['sel'] = 'Sel';
$string['sellerID'] = 'Identification du commerçant (SIRET, RCS, autre...)';
