...
$string['allbillsfile'] = 'Courseshop_{$a}_All_Bills';
$string['exportonlinetransactionid'] = 'Online TXID';
$string['exporttransactionid'] = 'TXID';
$string['exportidnumber'] = 'Lettering';
$string['exporttitle'] = 'Bill heading';
$string['exportworktype'] = 'Type';
$string['exportstatus'] = 'Status';
$string['exportuntaxedamount'] = 'Untaxed';
$string['exporttaxes'] = 'Taxes';
$string['exportamount'] = 'Taxed';
$string['exportitems'] = 'Items';
$string['exportemissiondate'] = 'Date';
$string['exportlastactiondate'] = 'Last action';
$string['exportfirstname'] = 'Firstname';
$string['exportlastname'] = 'Lastname';
$string['exportaddress1'] = 'Address';
$string['exportzip'] = 'Zip';
$string['exportcountry'] = 'Country';
$string['exportcity'] = 'City';
$string['exportusername'] = 'Username';
$string['exportasxls'] = 'Exporter vers Excel';
$string['allbillsfile'] = 'Courseshop_{$a}_Transactions';
$string['exportonlinetransactionid'] = 'Online TXID';
$string['exporttransactionid'] = 'TXID';
$string['exportidnumber'] = 'Lettrage';
$string['exporttitle'] = 'Titre';
$string['exportworktype'] = 'Type';
$string['exportstatus'] = 'Etat';
$string['exportuntaxedamount'] = 'HT.';
$string['exporttaxes'] = 'Taxes';
$string['exportamount'] = 'TTC.';
$string['exportitems'] = 'Produits';
$string['exportemissiondate'] = 'Date';
$string['exportlastactiondate'] = 'Dernière action';
$string['exportfirstname'] = 'Prénom';
$string['exportlastname'] = 'Nom';
$string['exportaddress1'] = 'Adresse';
$string['exportzip'] = 'Zip';
$string['exportcountry'] = 'Pays';
$string['exportcity'] = 'Ville';
$string['exportemail'] = 'Email';
$string['exportusername'] = 'Identifiant Moodle';
