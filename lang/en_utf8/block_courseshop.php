...
//capabilities
$string['courseshop:beassigned'] = "Be assigned";
$string['courseshop:salesadmin'] = "Is Sales Administrator";
...
$string['configdefaultcountry'] = 'Default for all instances of courseshop';
...
$string['configsellerID'] = 'Seller Administrative or legal registration ID';
...
$string['configsellerzip'] = 'ZIP Code of the merchant';
$string['configtestmode'] = 'When enabled the payment APIs will run in test mode (Paypal, SystemPay, ...)';
$string['configtitle'] = 'Block title';
$string['configtvaeurope'] = 'The VAT ID for European resellers';
$string['configuseshipping'] = 'If enabled, the physical shipping is enabled, allowing applying shipping costs to purchases';
$string['controls'] = 'Controls';
$string['countrycodelist'] = 'Country Restriction Code List';
...
$string['customerdefaultcountry'] = 'Customer default country';
$string['customername'] = 'Customer name';
$string['customerorganisationrequired'] = 'Customer organization required';
$string['customersdeleted'] = 'Customer base deleted';
$string['dedicated'] = 'Spécific';
$string['defaultcountry'] = 'Default customer country';
...
$string['eula_help'] = 'Some of our products you choosed for purchasing need and End Licence Agreement requirement, regarding to privacy statements or complementary services that come bundled to your purchasing. Please read carefully the following statements and agree to the terms to continue yourordering operation.';
$string['eulaagree'] = 'I agree';
$string['eulaheading'] = 'End User Licence Agreement';
$string['eulaurl'] = 'Licence agreement URL';
...
$string['gotobackoffice'] = 'Go to backoffice';
...
$string['printtabbedcategories'] = 'Print categories with tabs';
...
$string['sel'] = 'Sel';
$string['sellerID'] = 'Seller Registration ID';
...
$string['useshipping'] = 'Enable shipping processor';
